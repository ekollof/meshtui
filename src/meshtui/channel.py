...
class ChannelManager:
    ...
    async def get_channels(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if hasattr(self.meshcore, 'channel_info_list') and self.meshcore.channel_info_list:
                channels = []
    ...
    async def join_channel(self, channel_name: str, key: str = "") -> bool:
        ...
        try:
            ...
            self.logger.info(f"Successfully joined channel '{channel_name}' in slot {available_slot}")
            return True
